    ...
    es: {
        translation: {
            ...
            "aboutMe": {
                ...
                "description1": "Desarrolladora full-stack con curiosidad y talento para el diseño. Me apasiona dar vida a los aspectos técnicos y visuales de los productos digitales. Me preocupo por la experiencia del usuario, los píxeles bonitos y escribir código limpio, accesible y humano. Me gustan los detalles. Y como seguidora de las Leyes de la Simplicidad de John Maeda, estoy de acuerdo en que menos es más.",
                "description2": "Soy técnica en programación de la Universidad Tecnológica Nacional (Mendoza-Argentina), tengo cursos certificados en algoritmos de JavaScript heredados y estructura de datos. Tengo amplios conocimientos de HTML, CSS, JS, TS, React y Java.",
            ...
            "projects": {
                ...
                "description6": "Sistema contable que permite realizar asientos, cargar y editar planes de cuentas y llevar un control de los movimientos de cada ejercicio. Desarrollado en php.",
            },
            "skills": {
